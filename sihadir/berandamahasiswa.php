...
<body>
  <div class="beranda">
    <div class="body">
      <nav>
        <a class="sihadir" href="berandamahasiswa.php">
        ...
        <div class="container">
          <div class="dashboard">
            <div class="data-dashboard">
              ...
              <a href="berandamahasiswa.php" style="color:black;text-decoration:none">
                <p>Dashboard</p>
              </a>
            </div>
            <div class="detail">
              ...
              <div class="dropdown" id="dropdown">
                <a href="absensimahasiswa.php" style="color:white;text-decoration:none">
                  <p>PRESENSI</p>
                </a>
              </div>
            </div>
    ...
    <div class="content">
      <div class="title">
        ...
        <h1 class="center">Selamat Datang <?php echo $namaMahasiswa; ?>
        </h1>
      </div>
      <div class="admin">
        <div class="polnep">
